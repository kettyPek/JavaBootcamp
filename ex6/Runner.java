...
public class Runner {
	...
	//else return new integer which every digit is the minimum digit of the integers
	...
	//Question 4b
	//Receives an array and array's length, returns number of elements who's digits sum equal to 10
	...
	//Question 6
	//Receives matrix, returns TRUE if a row sum equals to same  col sum, else returns FALSE
	...
	//Question 7
	//Receives matrix and dimension, returns TRUE if the matrix is mirrored, else return False
	...
	//Question 8
	//Receives 2 arrays that represents integers and return the sum o the arrays in new array
	...
	//shift char 2 cells left for dir=-1 or right for dir=1, print array before shifting
